...
class AddBuyer extends StatelessWidget {
  AddBuyer({Key? key}) : super(key: key);
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: UnderlinedTitle(
            title: AppLocalizations.of(context)!.addBuyer,
                  ...
                  Padding(
                    ...
                    child: GradientButton(
                      onTap: () {
                        ...
                        context.read<BuyerBloc>().validateBuyer(
  ...
  void _handleListen(BuildContext context, BuyerState state) {
    if (state.buyerStatus == BuyerStatus.createValidated) {
            ...
            return BlocProvider.value(
              ...
              child: Builder(
                builder: (_context) => ConfirmOperation<BuyerBloc, BuyerState>(
                  ...
                  onConfirm: () => _context.read<BuyerBloc>().addBuyer(),
                  listener: (context, state) {
    ...
    return RichText(
      text: TextSpan(
        ...
        children: [
          ...
          TextSpan(
            text: AppLocalizations.of(context)!.addNewBuyer,
